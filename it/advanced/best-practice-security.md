---
layout: page
title: Sicurezza Migliori Pratiche per Express in Produzione
...
{% include admonitions/note.html content="Se credi di aver scoperto una vulnerabilità di sicurezza in Express, consulta
[Politiche e procedure di sicurezza](/en/resources/contributing.html#security-policies-and-procedures).
" %}
...
Express 2.x e 3.x non sono più mantenuti. Problemi di sicurezza e prestazioni in queste versioni non saranno risolti. Non usarli! Se non hai spostato nella versione 4, segui la [guida alla migrazione](/{{ page.lang }}/guide/migrating-4.html) o prendi in considerazione [Opzioni di Supporto Commerciale](/{{ page.lang }}/support#commercial-support-support-options).

Assicurati inoltre di non usare nessuna delle versioni Express vulnerabili elencate nella [pagina Aggiornamenti di sicurezza](/{{ page.lang }}/advanced/security-updates.html). Se lo si è, aggiornare a una delle versioni stabili, preferibilmente l'ultimo.
...
{% include admonitions/note.html content="Disabilitare l'intestazione `X-Powered-By ` non impedisce ad
un sofisticato attaccante di determinare che un'app è in esecuzione Express. Potrebbe
scoraggiare un exploit casuale, ma ci sono altri modi per determinare un'app sta eseguendo
Express." %}
...
[aggiungendo il tuo gestore non trovato](/en/starter/faq.html#how-do-i-handle-404-responses)
e
[scrivendo il tuo gestore di errore](/en/guide/error-handling.html#writing-error-handlers):
