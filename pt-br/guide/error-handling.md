---
layout: page
title: Solução de erro expressa
...
Outro erro de manipulação de middleware pode ser encontrado em [Express middleware](/{{ page.lang }}/resources/middleware.html).
...
<div class="doc-box doc-info" markdown="1">
Chama para `next()` e `next(err)` indicam que o manipulador atual está completo e em que estado.  O `next(err)` pulará todos os manipuladores restantes na cadeia, exceto aqueles que estão configurados para lidar com erros conforme descrito acima.
</div>
