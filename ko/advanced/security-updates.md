...
- 4.20.0
  ...
  - 의존성 `fresh`가 [발견된 취약점](https://github.com/advisories/GHSA-m6fv-jmcg-4jfg)에 따라 업데이트되었습니다.
...
- 4.17.3
  - 의존성 `ms`가 [발견된 취약점](https://github.com/advisories/GHSA-hrpp-h998-j3pp)에 따라 업데이트되었습니다. `req.query`, `req.body`, `req.param`, `, `을 사용하는 애플리케이션에 영향을 끼칠 수 있습니다.
- 4.16.0
