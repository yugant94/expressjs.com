---
layout: page
title: Beste Sicherheitspraktiken für Express in der Produktion
...
Express 2.x und 3.x werden nicht mehr gewartet. Sicherheits- und Leistungsprobleme in diesen Versionen werden nicht behoben. Verwenden Sie sie nicht! Wenn du nicht zu Version 4 gewechselt hast, folge der [Migrationsanleitung](/{{ page.lang }}/guide/migrating-4.html) oder erwäge [Handelsunterstützungsoptionen](/{{ page.lang }}/support#commercial-support-options).

Vergewissern Sie sich auch, dass Sie keine der verwundbaren Express-Versionen auf der [Seite für Sicherheitsaktualisierungen](/{{ page.lang }}/advanced/security-updates.html) verwenden. Wenn Sie dies tun, aktualisieren Sie auf eine der stabilen Releases, vorzugsweise die neuste.
...
{% include admonitions/note.html content="Deaktivieren des `X-Powered-By header` hindert
ein anspruchsvoller Angreifer nicht daran, festzustellen, dass eine App Express ausführt. Es kann
eine Gelegenheitsausnutzung abschrecken, aber es gibt andere Möglichkeiten, um festzustellen, dass eine App
Express läuft." %}
...
geändert werden [füge deinen eigenen nicht gefundenen Handler hinzu](/en/starter/faq.html#how-do-i-handle-404-responses)
und
[deinen eigenen Fehler zu schreiben](/en/guide/error-handling.html#writing-error-handlers):
